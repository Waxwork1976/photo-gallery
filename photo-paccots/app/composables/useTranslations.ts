...
const defaultEn: TranslationDictionary = {
  ...
  'gallery.taxonomySuggest.button': 'Suggest taxonomy change',
  'gallery.taxonomySuggest.saved': 'Taxonomy suggestion sent for review.',
  'gallery.taxonomySuggest.savedDetail': 'Your suggestion has been submitted successfully.',
  ...
  'manage.delete.warningPrefix': 'Warning:',

  'manage.submenu.images': 'Images',
  'manage.submenu.translations': 'Translations',
  'manage.submenu.taxonomySuggestions': 'Taxonomy suggestions',
  ...
  'project.timeline.title': 'Species timeline',
  'project.timeline.subtitle': 'Month-by-month number of uploaded pictures for the selected year.',
  'project.timeline.yearLabel': 'Year',
  ...
  'taxonomySuggest.title': 'Suggest taxonomy change',
  'taxonomySuggest.currentTaxonomy': 'Current taxonomy',
  'taxonomySuggest.identity': 'Your identity',
  'taxonomySuggest.authenticatedAs': 'Authenticated as',
  'taxonomySuggest.email': 'Email',
  'taxonomySuggest.emailPlaceholder': 'you@example.com',
  'taxonomySuggest.suggestedOrder': 'Suggested order',
  'taxonomySuggest.suggestedFamily': 'Suggested family',
  'taxonomySuggest.suggestedGenus': 'Suggested genus',
  'taxonomySuggest.suggestedScientificName': 'Suggested scientific name',
  'taxonomySuggest.suggestedCommonName': 'Suggested common name',
  'taxonomySuggest.note': 'Note (optional)',
  'taxonomySuggest.notePlaceholder': 'Why should this taxonomy change?',
  'taxonomySuggest.captchaLabel': 'CAPTCHA verification',
  'taxonomySuggest.captchaMissing': 'Please complete the CAPTCHA verification.',
  'taxonomySuggest.captchaUnavailable': 'CAPTCHA is not configured yet.',
  'taxonomySuggest.requiredEmail': 'Email is required.',
  'taxonomySuggest.invalidEmail': 'Please enter a valid email address.',
  'taxonomySuggest.localOnlyNotice': 'Your suggestion will be sent to reviewers.',
  'taxonomySuggest.cancel': 'Cancel',
  'taxonomySuggest.saveDraft': 'Send suggestion',

  'taxonomyManage.title': 'Manage taxonomy suggestions',
  'taxonomyManage.subtitle': '{count} pending suggestion(s)',
  'taxonomyManage.refresh': 'Refresh',
  'taxonomyManage.loading': 'Loading suggestions...',
  'taxonomyManage.empty': 'No pending suggestions.',
  'taxonomyManage.loadError': 'Failed to load suggestions.',
  'taxonomyManage.acceptError': 'Failed to accept suggestion.',
  'taxonomyManage.rejectError': 'Failed to reject suggestion.',
  'taxonomyManage.submittedAt': 'Submitted at',
  'taxonomyManage.requester': 'Requester',
  'taxonomyManage.email': 'Email',
  'taxonomyManage.currentTaxonomy': 'Current taxonomy',
  'taxonomyManage.suggestedTaxonomy': 'Suggested taxonomy',
  'taxonomyManage.note': 'Note',
  'taxonomyManage.contactAuthor': 'Contact author',
  'taxonomyManage.reject': 'Reject',
  'taxonomyManage.accept': 'Accept',
  'taxonomyManage.mailSubject': 'Taxonomy suggestion review',
  'taxonomyManage.mailBody.greeting': 'Hello,',
  'taxonomyManage.mailBody.image': 'Image',
  'taxonomyManage.mailBody.current': 'Current scientific name',
  'taxonomyManage.mailBody.suggested': 'Suggested scientific name',
  'taxonomyManage.mailBody.note': 'Suggestion note',
  'taxonomyManage.mailBody.signature': 'Best regards, Photo Paccots review team',

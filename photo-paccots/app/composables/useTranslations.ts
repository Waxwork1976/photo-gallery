...
const defaultEn: TranslationDictionary = {
  ...
  'gallery.taxonomySuggest.saved': 'Taxonomy suggestion draft saved locally.',
  'gallery.taxonomySuggest.savedDetail': 'This suggestion is not sent yet. Transmission will be implemented later.',
  ...
  'taxonomySuggest.requiredEmail': 'Email is required for guest suggestions.',
  'taxonomySuggest.invalidEmail': 'Please enter a valid email address.',
  'taxonomySuggest.localOnlyNotice': 'Saved locally only. This feedback is not transmitted yet.',
  'taxonomySuggest.cancel': 'Cancel',
  'taxonomySuggest.saveDraft': 'Save draft',

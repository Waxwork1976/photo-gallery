...
public sealed class SaveMetadataFunction
{
        ...
        [HttpTrigger(AuthorizationLevel.Anonymous, "post", Route = "save-metadata")] HttpRequest req)
    {
        ...
        var entity = new PhotoEntity
        {
            ...
            SpeciesType = SpeciesMetadata.NormalizeSpeciesType(body.SpeciesType),
            ScientificName = SpeciesMetadata.NormalizeText(body.ScientificName),
            TaxonomyOrder = SpeciesMetadata.NormalizeText(body.TaxonomyOrder),
            TaxonomyFamily = SpeciesMetadata.NormalizeText(body.TaxonomyFamily),
            TaxonomyGenus = SpeciesMetadata.NormalizeText(body.TaxonomyGenus),
            CommonNamesJson = SpeciesMetadata.SerializeCommonNames(body.CommonNames),
